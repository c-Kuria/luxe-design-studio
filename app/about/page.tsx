...
const team = [
  {
    ...
    bio: "With over 15 years of experience in interior design and architecture, Alexandra founded Fanisi Atelier with a vision to create spaces that are both beautiful and functional.",
  },
  {
    id: 2,
    name: "Michael Chen",
    ...
    bio: "Michael brings 12 years of architectural expertise to the team, specializing in sustainable design and innovative structural solutions.",
  },
  {
    id: 3,
    ...
    bio: "Sophia's keen eye for color and texture has helped shape the studio's distinctive aesthetic, blending contemporary elements with timeless design principles.",
  },
  {
    id: 4,
    name: "James Wilson",
