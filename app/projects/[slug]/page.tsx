...
const projects = [
  {
    ...
    year: 2023,
    description:
      "A complete renovation of a 3,500 sq ft penthouse in the heart of Manhattan. The design focuses on clean lines, a neutral color palette, and luxurious materials to create a sophisticated urban retreat.",
    challenge:
